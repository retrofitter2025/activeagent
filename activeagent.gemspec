...
Gem::Specification.new do |spec|
  ...
  # Add dependencies
  spec.add_dependency "actionpack", ">= 7.2.1.2"
  spec.add_dependency "actionview", ">= 7.2.1.2"
  spec.add_dependency "activesupport", ">= 7.2.1.2"
  spec.add_dependency "activemodel", ">= 7.2.1.2"
  spec.add_dependency "activejob", ">= 7.2.1.2"
